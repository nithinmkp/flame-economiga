...
subtitle: Methods for Real-World Forecasting
author: 
  - name: Nithin M
...
format:
  metropolis-revealjs:
    ...
    preview-links: true
    controls: true
    footer: "https://github.com/nithinmkp/flame-economiga"
    slide-level: 3
brand: false
---
```{r}
...
### Stationary Time Series {.scrollable}
- 3 important process
...
### Converting to time series object {.scrollable}
::: {.panel-tabset}
### Default `tsibble` conversion
```{r}
#| echo: true
library(tsibble)
ts_data <- table %>%
...
### 
Load the data `gh_data.csv` 
- some cleaning
  - pivoting and making tidy data
...
### Working Dates and Time {.scrollable}
